export const FAQList = {
  FAQ_EN: [
    ...
    },
    {
      ...
      answer:
        "Our is free, open-source, and powerful, making it ideal for various projects and marketing campaigns. It allows you to create a landing page in under an hour, simplifying the development process while also offering a high degree of customization and responsiveness.",
    },
    {
      question: "What skills do I need to use this template?",
      answer:
        "To use our, you only need basic web editing skills. The design of the template is intended to be easy for non-technical users to get started with, while also providing high customizability for experienced developers.",
    },
    {
      question: "How do I get started with the?",
      answer:
    ...
    {
      question: "Does the support responsive design?",
      answer:
        "Yes, our supports responsive design, ensuring that your webpage displays perfectly on a variety of devices, whether desktop, tablet, or smartphone.",
    },
    {
    ...
    },
    {
      ...
      answer:
        "No. You are free to use and modify this template. At the same time, we encourage developers to submit PRs to help improve this together.",
    },
    {
